...
| 3 | **ECOSIRE.AI** | `D:\ECOSIRE.AI\` | `README.md` + `memory/ecosire_ai.md` | Autonomous SEO/AEO/GEO SaaS: FastAPI + Next.js 16 + PostgreSQL 16 + Celery + Claude/GPT. Live at ecosir.ai. 11 Docker containers on EC2 t3.large. WP plugin v2.1.0. **NOT** OpenClaw AI. |
