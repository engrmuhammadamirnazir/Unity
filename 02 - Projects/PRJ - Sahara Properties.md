...
| **SSH User**       | bitnami                                         |
| **PEM Key**        | `D:/EcosireClients/ProjectClients/Sahara-Properties/sahara.pem` (see [[Server & Key Inventory]]) |
...
- **2026-04-22 (late eve)**: res.partner dedup — 247→184 partners on prod, testingsahara re-cloned from post-merge prod. Reusable pipeline at `D:/EcosireClients/ProjectClients/Sahara-Properties/scripts/partner_dedup/`.
